        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Client_District_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientOrderPayments_Client_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderFees = table.Column<float>(type: "real", nullable: false),
                    DriveryFees = table.Column<float>(type: "real", nullable: false),
                    MaterialFees = table.Column<float>(type: "real", nullable: true),
                    DriveryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Orders_District_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "District",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_Employee_DriveryId",
                        column: x => x.DriveryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    permissrionId = table.Column<int>(type: "int", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissrionId = table.Column<int>(type: "int", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Permissrion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Permissrion_EmployeeType_EmployeeTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Client_DistrictId",
                table: "Client",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientOrderPayments_ClientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeePermission_permissrionId",
                table: "EmployeePermission",
                column: "permissrionId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeType_PermissrionId",
                table: "EmployeeType",
                column: "PermissrionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissrion_EmployeeTypeId",
                table: "Permissrion",
                column: "EmployeeTypeId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_EmployeePermission_Permissrion_permissrionId",
                table: "EmployeePermission",
                column: "permissrionId",
                principalTable: "Permissrion",
                principalColumn: "Id",
                onDelete: ReferentialAction.NoAction);

            migrationBuilder.AddForeignKey(
                name: "FK_EmployeeType_Permissrion_PermissrionId",
                table: "EmployeeType",
                column: "PermissrionId",
                principalTable: "Permissrion",
                principalColumn: "Id");
